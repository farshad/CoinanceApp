...
import { ProfileNavigator, HomeNavigator, DealNavigator, SupportNavigator } from './StackNavigator';
      ...
      return (
        ...
        <FooterTab style={styles.footerTab}>
          ...
          <Button
            ...
            onPress={() => props.navigation.navigate("Deal")}>
            <Icon style={props.navigation.state.index === 1 ? styles.activeIconAndTxt : styles.inactiveIcon} name="cash" />
          ...
          <Button
            ...
            <Icon style={props.navigation.state.index === 2 ? styles.activeIconAndTxt : styles.inactiveIcon} name="person" />
            {props.navigation.state.index === 2 && (<Text style={props.navigation.state.index === 2 ? styles.activeIconAndTxt : null}>{ i18n.t('mainTab.profile') }</Text>)}
          </Button>
          <Button
            style={props.navigation.state.index === 3 ? styles.activeBtn : null}
            vertical
